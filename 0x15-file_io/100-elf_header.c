...
void prints_vsn(unsigned char *e_ident);
 ...
 * @e_ident: A pointer to an arra containing the ELF magic numbers.
 */
void prints_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * prints_vsn - Prints the version of an ELF header.
...
/**
 * prints_abi - Prints the ABI version of an ELF header.
...
/**
 * prints_type - Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void prints_type(unsigned int e_type, unsigned char *e_ident)
